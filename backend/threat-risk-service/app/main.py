...
FastAPI application for threat analysis and risk assessment.
"""
...
SERVICE_NAME = "tara-threat-risk-service"
...
app = FastAPI(
    title="TARA Threat and Risk Analysis Service",
    description="威胁风险分析服务 - 提供STRIDE分析、攻击路径构建和风险评估功能",
