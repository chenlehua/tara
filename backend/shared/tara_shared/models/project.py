...
class Project(BaseModel):
    ...
    status = Column(Integer, default=0)  # 0: draft, 1: in_progress, 2: completed, 3: archived
    ...
    threat_risks = relationship("ThreatRisk", back_populates="project", cascade="all, delete-orphan")
