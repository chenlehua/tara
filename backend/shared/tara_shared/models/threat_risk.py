...
class ThreatRisk(BaseModel):
    ...
    damage_scenario_id = Column(Integer, ForeignKey("damage_scenarios.id", ondelete="SET NULL"), nullable=True)
    ...
    risk_level = Column(String(20), nullable=True)  # negligible, low, medium, high, critical
    ...
    attack_paths = relationship("AttackPath", back_populates="threat_risk", cascade="all, delete-orphan")
...
class AttackPath(BaseModel):
    ...
    threat_risk_id = Column(Integer, ForeignKey("threat_risks.id", ondelete="CASCADE"), nullable=False, index=True)
    ...
    feasibility_rating = Column(String(20), nullable=True)  # low, medium, high, very_high
    ...
    control_measures = relationship("ControlMeasure", back_populates="attack_path", cascade="all, delete-orphan")
...
class ControlMeasure(BaseModel):
    ...
    attack_path_id = Column(Integer, ForeignKey("attack_paths.id", ondelete="CASCADE"), nullable=False, index=True)
    ...
    implementation_status = Column(Integer, default=0)  # 0: planned, 1: in_progress, 2: implemented
