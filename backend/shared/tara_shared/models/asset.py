...
class Asset(BaseModel):
    ...
    parent_id = Column(Integer, ForeignKey("assets.id", ondelete="SET NULL"), nullable=True)
    ...
    damage_scenarios = relationship("DamageScenario", back_populates="asset", cascade="all, delete-orphan")
