...
FastAPI application for asset management and discovery.
"""
...
SERVICE_NAME = "tara-asset-service"
...
app = FastAPI(
    title="TARA Asset Identification Service",
    description="资产识别服务 - 提供资产发现、分类和关系构建功能",
