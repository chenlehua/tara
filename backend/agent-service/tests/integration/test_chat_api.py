...
class TestChatAPI:
    ...
    def test_chat_endpoint(self, mock_client, client, sample_chat_request, mock_llm_response):
        """Test chat endpoint."""
...
class TestAgentAPI:
    ...
    def test_get_task_status(self, client, sample_analyze_request):
        ...
        start_response = client.post("/api/v1/agents/analyze", json=sample_analyze_request)
