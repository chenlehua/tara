...
class WordGenerator:
    ...
    async def generate(
        ...
        core_properties.title = f"TARA Report - {data.get('project', {}).get('name', 'Unknown')}"
    ...
    async def _generate_iso21434_sections(
        ...
        doc.add_paragraph("Impact assessment considers safety, financial, operational, and privacy impacts.")
        
        doc.add_heading("5.2 Attack Feasibility Assessment", 2)
        doc.add_paragraph("Attack feasibility is evaluated based on attack potential factors.")
        ...
        doc.add_paragraph("STRIDE - Spoofing, Tampering, Repudiation, Information Disclosure, Denial of Service, Elevation of Privilege")
